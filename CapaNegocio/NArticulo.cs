...
namespace CapaNegocio
{
    public class NArticulo
    {
        ...
        //de la CapaDatos
        public static string Insertar(string codigo, string nombre, string descripcion, byte[] imagen, string stock, string precioCompra, string precioVenta)
        {
        ...
        //de la CapaDatos
        public static string Editar(int idarticulo, string codigo, string nombre, string descripcion, byte[] imagen, string stock, string precioCompra, string precioVenta)
        {
            DArticulo Obj = new DArticulo();
