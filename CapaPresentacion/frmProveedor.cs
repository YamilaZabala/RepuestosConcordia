...
namespace CapaPresentacion
{
    public partial class frmProveedor : Form
    {
        ...
        public frmProveedor()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtCuit, "Ingrese Número de Documento del Proveedor");
        ...
        {
            this.dataListado.DataSource = NProveedor.BuscarCuit(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string rpta = "";
                if (this.txtRazon_Social.Text == string.Empty || this.txtCuit.Text == string.Empty
                    || this.txtDireccion.Text == string.Empty)
                {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NProveedor.Insertar(this.txtRazon_Social.Text.Trim().ToUpper(),
                            this.cbSector_Comercial.Text, txtCuit.Text, txtDireccion.Text, txtTelefono.Text,
