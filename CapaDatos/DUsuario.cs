    ...
    public class DUsuario
    {
        ...
        public string Insertar(DUsuario Usuarios)
        {
            ...
            try
            {
                ...
                ParFecha_Nacimiento.Value = Usuarios.Fecha_Nacimiento;
                ...
                ParDireccion.Value = Usuarios.Direccion;
                ...
                ParTelefono.Size = 11;
                ParTelefono.Value = Usuarios.Telefono;
        ...
        public DataTable BuscarNombre(DUsuario Usuario)
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spbuscar_usuario_nombre";
                SqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarCuit(DUsuario Usuario)
        {
            DataTable DtResultado = new DataTable("clientes");
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spbuscar_usuario_cuit";
                SqlCmd.CommandType = CommandType.StoredProcedure;
