...
namespace CapaDatos
{
    public class DArticulo
    {
        ...
        public DArticulo(int idarticulo, string codigo, string nombre, string descripcion, byte[] imagen, string stock, string precioCompra, string precioVenta, string textobuscar)
        {
