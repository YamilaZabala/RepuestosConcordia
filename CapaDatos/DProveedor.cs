...
namespace CapaDatos
{
    public class DProveedor
    {
        ...
        public DProveedor(int idproveedor, string razon_social, string sector_comercial, string num_documento, string direccion, string telefono, string email, string url, string textobuscar)
        {
        ...
        public DataTable BuscarCuit(DProveedor Proveedor)
        {
            DataTable DtResultado = new DataTable("proveedor");
            SqlConnection SqlCon = new SqlConnection();
            try
